...
const CreateCrop = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .post('http://localhost:4000/crops', { ...crop }, config)
      .then(({ data }) => {
        console.log(1, data);
              ...
              <div className='-mx-4 flex justify-center'>
                <form className='w-full max-w-lg' onSubmit={handleSubmit}>
                  ...
                  <div className='Nitrogen flex items-center'>
                    <h3 className='text-xl mb-4 mr-4 w-48 text-right'>
                      Nitrogen:
                    </h3>
                    <div className='flex flex-wrap -mx-3 mb-6'>
                      <div className='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
                  ...
                  <div>
                    <button
                      className='bg-green-400 py-4 w-96 -mr-32 rounded-md hover:bg-green-300'
                      type='submit'
                    >
                      Submit
                    </button>
